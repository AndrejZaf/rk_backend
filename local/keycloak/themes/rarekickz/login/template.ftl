<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false>
    ...
    <head>
        ...
        <script type="module">
            import {checkCookiesAndSetTimer} from "local/keycloak/themes/rarekickz";
    ...
    <div class="container">
        ...
        <div class="bg-circle-2 bg-circle-half"></div>
        <div class="bg-circle-3 bg-circle-half-up"></div>
        ...
        <div class="pf-v5-c-login__container">
            <main>
                <header class="pf-v5-c-login__main-header">
                    <h1 class="pf-v5-c-title pf-m-3xl fw-semibold text-uppercase text-center"
                        id="kc-page-title"><#nested "header"></h1>
